// Previous industry implementation, preserved as requested.
// "use client";
//
...
export function IndustryPanels({ onPick }: { onPick: (cat: string) => void }) {
  return <IndustryCards variant="portfolio" onPick={onPick} />;
}
